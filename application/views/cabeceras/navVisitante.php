...
<header>
    <div class="logo">
        ...
        <div class="calls-header">
            <nav>
                <a href="<?= base_url(); ?>controladorVisitante/cargarVistaInicio"> <b>Inicio</b> </a>
                <a href="<?= base_url(); ?>controladorVisitante/agregar"> <b>Registrarse</b> </a>
                <a href="<?= base_url(); ?>controladorVisitante/cargarVistaArticulos"> <b>Ver Articulos</b> </a>

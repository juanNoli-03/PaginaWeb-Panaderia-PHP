...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>multimedia/css/clienteStyle.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/clienteStyle.css">
    <title>Cliente</title>
</head>
<body>  
    <section class="form-log">
        <form action="<?= base_url(); ?>ControladorCliente/validarUsuario" method="POST"> 
